...
(function ($) {
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td>' + this.name + '</td>' +
          '<td title="Unit Price" class="text-right">' + options.currencySymbol + (this.price).toLocaleString('id-ID') + '</td>' +
    ...
    var showGrandTotal = function () {
      $("#" + idGrandTotal).text(options.currencySymbol + (ProductManager.getTotalPrice()).toLocaleString('id-ID'));
    };
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).text(options.currencySymbol + (price * quantity).toLocaleString('id-ID'));
