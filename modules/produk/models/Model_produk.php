...
class Model_produk extends MY_Model {
    ...
    public $field_search   = ['nama_produk', 'deskripsi_produk', 'harga', 'id_kategori', 'photo', 'kategori.nama_kategori'];
    ...
    public function join_avaiable() {
        ...
        $this->db->select('kategori.nama_kategori,produk.*,kategori.nama_kategori as kategori_nama_kategori,kategori.nama_kategori as nama_kategori');
